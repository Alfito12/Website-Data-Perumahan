...
<body>
  ...
  <main id="main">
      ...
      <div class="container mt-7">
        ...
        <form method="POST" action="" enctype="multipart/form-data">
          ...
          <div class="form-group mt-3">
              <label for="">Nama Batas</label>
              <input class="form-input" name="nama_batas" type="text">
            </div>
            <div class="form-group mt-3">
    ...
    if(isset($_POST['submit'])){
        $nama_batas	= $_POST['nama_batas'];
        $geojson	= $_POST['geojson'];
        
        $sql = mysqli_query($koneksi, "SELECT * FROM batas WHERE id_batas='$id_batas'") or die(mysqli_error($koneksi));

        if(mysqli_num_rows($sql) == 0){
            $sql = mysqli_query($koneksi, "INSERT INTO batas(id_batas, nama_batas, geojson) VALUES('', '$nama_batas', '$geojson')") or die(mysqli_error($koneksi));
            if($sql){
                echo '<script>alert("Berhasil menambahkan data map."); document.location="tambah_batas.php";</script>';
            }else{
